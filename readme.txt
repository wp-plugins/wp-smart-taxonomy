...
== Installation ==
1. Upload the `wp-smart-taxonomy` folder to the `/wp-content/plugins/` directory OR search for "WP Smart Taxonomy" from your Wordpress admin.
2. Activate the plugin through the 'Plugins' menu in Wordpress.
3. Configure the plugin settings through the "WP Smart Taxonomy" menu on your Wordpress admin panel.

                                  ...
                                  "sections" => array(
                                                      "default_settings_section" => array("title" =>  __('', $DC_Wp_Smart_Taxonomy->text_domain), // Section one
                                                                                         "fields" => array(
                                                                                                           ...
                                                                                                           "is_append" => array('title' => __('Append with existing categories', $DC_Wp_Smart_Taxonomy->text_domain), 'type' => 'checkbox', 'id' => 'is_append', 'label_for' => 'is_append', 'name' => 'is_append', 'value' => 'Append', 'desc' => __('If unchecked will replace existing categories', $DC_Wp_Smart_Taxonomy->text_domain)),
